...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'card card-image card-image--square' ); ?>>
	<a href="<?php esc_url( the_permalink() ); ?>" rel="bookmark">
		...
		<div class="card__info">
			<?php the_title( '<h2 class="entry-title card-title has-large-font-size">', '</h2>' ); ?>			
			<p class="card__text"><?php echo get_the_excerpt(); ?></p>

			<div class="card__cta">
				<span class="card__cta-text"><?php the_field( 'sector_budget_range' ); ?></span>
				<svg width="22" height="22" viewBox="0 0 22 22" fill="#e95c0c" xmlns="http://www.w3.org/2000/svg">
