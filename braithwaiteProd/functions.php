<?php
/**
 * braithwaite prod functions and definitions
 *
...
define( 'BRAITHWAITEPROD_MINIMUM_WP_VERSION', '4.7' );
define( 'BRAITHWAITEPROD_MINIMUM_PHP_VERSION', '7.0' );

// Bail if requirements are not met.
if ( version_compare( $GLOBALS['wp_version'], BRAITHWAITEPROD_MINIMUM_WP_VERSION, '<' ) || version_compare( phpversion(), BRAITHWAITEPROD_MINIMUM_PHP_VERSION, '<' ) ) {
...
if ( file_exists( get_template_directory() . '/vendor/autoload.php' ) ) {
	 ...
	 */
	function _braithwaiteProd_autoload( $class_name ) {
	...
	spl_autoload_register( '_braithwaiteProd_autoload' );
}

// Load the `braithwaiteProd()` entry point function.
require get_template_directory() . '/inc/functions.php';

// Initialize the theme.
call_user_func( 'WP_Rig\WP_Rig\braithwaiteProd' );
