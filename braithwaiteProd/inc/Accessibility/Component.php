...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			'braithwaiteProd-navigation',
			get_theme_file_uri( '/assets/js/navigation.min.js' ),
			array(),
			braithwaiteProd()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			false
		);
		wp_script_add_data( 'braithwaiteProd-navigation', 'async', true );
		wp_script_add_data( 'braithwaiteProd-navigation', 'precache', true );
		wp_localize_script(
			'braithwaiteProd-navigation',
			'braithwaiteProdScreenReaderText',
			array(
				'expand'   => __( 'Expand child menu', 'braithwaiteProd' ),
				'collapse' => __( 'Collapse child menu', 'braithwaiteProd' ),
			)
		);
	}
